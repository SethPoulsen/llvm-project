...
namespace {
/// RegAllocSS provides a minimal implementation of the basic register allocation
...
INITIALIZE_PASS_END(RegAllocSS, "RegAllocSS", "Sam + Seth Register Allocator", false,
                    false)
...
bool RegAllocSS::spillInterferences(LiveInterval &VirtReg, unsigned PhysReg,
                                 SmallVectorImpl<unsigned> &SplitVRegs) {
...
// selectOrSplit().
unsigned RegAllocSS::selectOrSplit(LiveInterval &VirtReg,
                                SmallVectorImpl<unsigned> &SplitVRegs) {
